...
```bash
python3 .agent/workflows/scripts/flutter_search.py "<keyword>" --top 5
python3 .agent/workflows/scripts/flutter_search.py "<keyword>" --stack riverpod --top 5
```
...
```bash
# Flutter Widgets
python3 .agent/workflows/scripts/flutter_search.py "ListView pagination" --top 5

# Design Patterns
python3 .agent/workflows/scripts/flutter_search.py "authentication login" --top 5

# Charts
python3 .agent/workflows/scripts/flutter_search.py "chart bar comparison" --top 5

# Typography
python3 .agent/workflows/scripts/flutter_search.py "font modern SaaS" --top 5

# Colors by Product
python3 .agent/workflows/scripts/flutter_search.py "fintech crypto dark" --top 5

# UX Guidelines
python3 .agent/workflows/scripts/flutter_search.py "touch target accessibility" --top 5

# UI Styles
python3 .agent/workflows/scripts/flutter_search.py "glassmorphism neumorphism" --top 5
```
...
1. **Search widgets:**
   ```bash
   python3 .agent/workflows/scripts/flutter_search.py "form input text field" --top 5
   ```
...
3. **Search packages:**
   ```bash
   python3 .agent/workflows/scripts/flutter_search.py "validation form" --stack riverpod --top 5
   ```

4. **Search colors:**
   ```bash
   python3 .agent/workflows/scripts/flutter_search.py "saas professional" --top 3
   ```
