...
```bash
python3 skills/flutter-pro-max/scripts/search.py/search.py "<keyword>" --top 5
```

**Với domain cụ thể:**
```bash
python3 skills/flutter-pro-max/scripts/search.py/search.py "<keyword>" --domain widget --top 5
python3 skills/flutter-pro-max/scripts/search.py/search.py "<keyword>" --domain package --top 5
```

**Với stack filter:**
```bash
python3 skills/flutter-pro-max/scripts/search.py/search.py "<keyword>" --stack riverpod --top 5
```
