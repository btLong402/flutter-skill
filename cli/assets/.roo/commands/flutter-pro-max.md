...
**Với domain cụ thể:**
```bash
python3 .roo/commands/scripts/search.py "<keyword>" --domain widget --top 5
python3 .roo/commands/scripts/search.py "<keyword>" --domain package --top 5
```
...
# Specific domain
python3 .roo/commands/scripts/search.py "network http" --domain package --top 5

# Stack filter
python3 .roo/commands/scripts/search.py "state" --stack riverpod --top 5

# JSON output
python3 .roo/commands/scripts/search.py "login" --json --top 3
```
...
1. **Search widgets:**
   ```bash
   python3 .roo/commands/scripts/search.py "form input" --domain widget --top 5
   ```

2. **Search patterns:**
   ```bash
   python3 .roo/commands/scripts/search.py "authentication login" --domain pattern --top 5
   ```

3. **Search packages:**
   ```bash
   python3 .roo/commands/scripts/search.py "validation" --domain package --stack riverpod --top 5
   ```
